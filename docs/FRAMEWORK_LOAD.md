...
| **v3 dispatch plan** | **`docs/ref/MAG_V3_DISPATCH_PLAN.md`** — restful cheap-agent waves to ship v3 |
...
| **Mesh comm clones (Bitchat/Briar/Bridgefy)** | FIND+FILE | `./scripts/pull_mesh_comm_repos.sh` · **`docs/ref/MESH_LOCAL_AGENT.md`** (deep dive + local agent) |
