...
**Activation:** `docs/FRAMEWORK_LOAD.md` · `python main.py verkle-audit --full` · `docs/ref/MAG_v2_PLAN.md` · **`docs/ref/MAG_PROJECT_PROPOSAL.md`** · this file.
...
**v3 scope:** spider, resonance, L-exp training, workstation GUI, riddle packs — see `docs/ref/MAG_v3_RESEARCH_PLAN.md` + **`docs/ref/MAG_v3_BACKLOG.md`** (living feature ledger). **Next coding run:** **`docs/ref/MAG_NEXT_CODING_RUN.md`**. **Restful v3 dispatch:** **`docs/ref/MAG_V3_DISPATCH_PLAN.md`**. Not v2 merge blockers.
